...
X = df[['Âge', 'Sport pratiqué_autre', 'Sport pratiqué_course sur route', 'Sport pratiqué_cyclisme ', 'Sport pratiqué_triathlon', 'Durée moyenne des règles', 'Prise en compte du cycle menstruel dans le plan d’entraînement',
        'Crainte de tâcher sous-vêtements', 'Contraception ?', "Programme d'entrainement", "Nombre d'entrainements par semaine_2 à 4 entrainements/semaine", "Nombre d'entrainements par semaine_4 à 6 entrainements/semaine", "Nombre d'entrainements par semaine_<2 entrainements/semaine", "Nombre d'entrainements par semaine_>6 entrainements/semaine"]]
